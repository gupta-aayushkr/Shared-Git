...
options.add_experimental_option("prefs", {
 "download.default_directory": r"/Users/aayushgupta/Desktop/VS Git - MM/Working/VM Code/pfp"
  })
...
# time.sleep(10)
# import numpy as np
# df = pd.read_csv('/Users/aayushgupta/Desktop/VS Git - MM/Working/VM Code/pfp/relatedQueries.csv',names=['Query', 'Value'])
...
# csv_files = glob.glob('/Users/aayushgupta/Desktop/VS Git - MM/Working/VM Code/pfp/relatedQueries *.{}'.format('csv'))
